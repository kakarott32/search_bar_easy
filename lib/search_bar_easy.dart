...
import 'package:search_bar_easy/widgets/filterable_list.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/foundation.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class SearchBarEasy extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<SearchBarEasy> createState() => _SearchBarEasyState();

  @override
  Size get preferredSize => Size.fromHeight(appBarHeight + (isFloating ? 5 : 0));
}

class _SearchBarEasyState extends State<SearchBarEasy> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Color? searchBackgroundColor =
        widget.searchBackgroundColor ?? scaffold!.widget.backgroundColor ?? theme.inputDecorationTheme.fillColor ?? theme.scaffoldBackgroundColor;
    ...
    TextStyle searchHintStyle =
        widget.searchHintStyle ?? theme.inputDecorationTheme.hintStyle ?? const TextStyle(color: Colors.grey, fontStyle: FontStyle.italic);

    IconThemeData searchBackIconTheme = widget.searchBackIconTheme ?? IconThemeData(size: 24, color: Theme.of(context).primaryColor);

    IconThemeData searchClearIconTheme = widget.searchClearIconTheme ?? IconThemeData(size: 24, color: Theme.of(context).primaryColor);
                                        ...
                                        children: [
                                          ...
                                          ...List.generate(
                                            ...
                                            (index) {
                                              ...
                                              return IconTheme(data: iconTheme, child: widget.actions[widget.putActionsOnRight ? (index - 1) : index]);
                                            },
                                            //tooltip: MaterialLocalizations.of(context).searchFieldLabel
                                          )
                                        ])),
                                        ...
                                        builder: (context, child) {
                                          return Container(
                                              ...
                                              width: _containerSizeAnimation.value * constraints.maxWidth -
                                                  (_containerSizeAnimation.value * (widget.isFloating ? 10 : 0)),
